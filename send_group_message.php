<?php
        ...
        $cat_query_group = "SELECT * FROM groups WHERE id = $grp_id" ;
        ...
        $cat_query_group0074 = "SELECT * FROM messages WHERE content = '$message' AND subject = '$subject' AND group_id= $_id " ;
                            ...
                            <div class="row">
                                <div class="col col-md-12 acc_header">
                                    ...
                                    <div class="contents text-center" style="margin-top: -60px">
                                        ...
                                        <P style="font-size:20px">Are you sure you want to send the message "<b><?php echo $message;?></b>" to <b><?php echo $_name;?></b> group?</P>

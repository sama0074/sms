...
<main class="content">
	<div class="container-fluid p-0">
		<div class="row">
            <div class="col-4"></div>
			<div class="col-4">
                <h1 class="h3 mb-3 text-center">Compose a bulk message</h1>
                    <?php 
                                    ...
                                    <form action="includes/server.php" method="POST">
                                        <div class="form-row mb-3">
                                            <div class="col col-sm-11">
                                                <label for="name">Number <span class="reqired">*</span></label>
                                                <input class="form-control" type="text" id="" placeholder="Enter phone number(s)" name="numbers" list="contact" required>
                                                <span style="color:red"><i>Enter phone numbers and separate each of them with a semicolon(;)</i></span>
                                            </div>
                                        </div>
                                        <div class="form-row mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-11 ml-auto">
                                                ...
                                                <div class="form-group text-center">
                                                    <button type="submit" class="btn btn-success" name="send_bulk">Send</button>
                                                    <button type="submit" class="btn btn-warning" name="draft">Draft</button>

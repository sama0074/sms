                                    ...
                                    <form action="includes/server.php" method="POST">
                                        <div class="form-row mb-3">
                                            <div class="col col-sm-11">
                                                <label for="name">Name <span class="reqired">*</span></label>
                                                <select class="form-control" type="text" id="" placeholder="Search contact name" name="name" list="contact" required>
                                                    <option selected disabled>Select Contact</option>
                                                    <?php 
                                                  
                                                        $cat_query_group = "SELECT * FROM contacts";
